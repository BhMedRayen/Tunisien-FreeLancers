<template>
      ...
      <v-menu offset-y transition="slide-x-transition" left class="mt-7" max-width="auto" min-width="300">    
                   <template v-slot:activator="{ on, attrs }">
                    <v-btn plain v-bind="attrs" v-on="on">
                     ...
                     <v-badge color="red" :content="notifications.length==0 ? '0' : notifications.length"></v-badge>
                    </v-btn>
                   </template>
                      <v-list>
                   ...
                   <v-list-item v-for="notif in notifications" :key="notif.id">
                       ...
                       <v-list-item-action>
                           <v-col cols="auto">
                                <v-btn color="red" plain @click="deleteNotificationById(notif.id)">
    ...
    <v-menu class="mx-4" offset-y :nudge-width="100">
